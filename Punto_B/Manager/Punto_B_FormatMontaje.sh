...
echo "UUID=$UUID_SDC1  /home/vagrant/manager/Servicios  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Servicios] Montando partición y creando estructura inicial..."
sudo mount /home/vagrant/manager/Servicios
sudo mkdir -p /home/vagrant/manager/Servicios/{Base_de_Datos,Cache,Web}
...
echo "UUID=$UUID_SDC2  /home/vagrant/manager/Monitoreo  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Monitoreo] Montando partición y creando subcarpetas..."
sudo mount /home/vagrant/manager/Monitoreo
sudo mkdir -p /home/vagrant/manager/Monitoreo/{Alertas,Logs,Metricas}
...
echo "UUID=$UUID_SDC5  /home/vagrant/manager/Servicios/Web  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Web] Montando la partición lógica dentro de Servicios/Web..."
sudo mount /home/vagrant/manager/Servicios/Web
...
echo "UUID=$UUID_SDC6  /home/vagrant/manager/Servicios/Cache  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Cache] Montando la partición lógica dentro de Servicios/Cache..."
sudo mount /home/vagrant/manager/Servicios/Cache
...
echo "UUID=$UUID_SDC7  /home/vagrant/manager/Monitoreo/Logs  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Logs] Montando la partición lógica dentro de Monitoreo/Logs..."
sudo mount /home/vagrant/manager/Monitoreo/Logs

# =====================================================================
# SECCIÓN 6: AJUSTE FINAL DE PERMISOS GLOBAL
echo "Asignando la propiedad de todas las estructuras al usuario 'vagrant'..."
sudo chown -R vagrant:vagrant /home/vagrant/manager/
